...
.blockstart_1: ; call
    ...
    jmp proc_cstr_println
.blockend_1: ; call
    push mem+586; lexer_includepath
.blockstart_2: ; call
    mov rax, [ret_stack_rsp]
    add rax, 16
    mov rbx, [loc_stack_rsp]
